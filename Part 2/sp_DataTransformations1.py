...
def data_transforms(data_dir, batch_sz):
    ...
    dataloaders = {'train_loader':torch.utils.data.DataLoader(image_datasets['training'],batch_size=batch_sz,shuffle=True),
                  'val_loader':torch.utils.data.DataLoader(image_datasets['validation'],batch_size=batch_sz,shuffle=True),
                   'test_loader':torch.utils.data.DataLoader(image_datasets['testing'],batch_size=batch_sz,shuffle=True)}        
