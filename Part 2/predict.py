...
from sp_Artificial_Intelligence import simple_load_rebuild_model, predict1, sp_sanity_checker  
...
parser.add_argument('--gpu', default=False, action='store_true', help="use must type --gpu to use the GPU")

# enable input from the command line

args = parser.parse_args()
data_dir = args.data_dir
###999 checkpoint = args.checkpoint_pth
...
# rebuild the model
###999 rebuilt_model = simple_load_rebuild_model(checkpoint) 
...
sp_sanity_checker(flower_names, data_dir, device, rebuilt_detailed_model, detailed_checkpoint, top_probs)
#789
