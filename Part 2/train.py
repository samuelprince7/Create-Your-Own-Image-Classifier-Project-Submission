...
from sp_Artificial_Intelligence import author_model, train_the_model, sp_save_model

from sp_DataTransformations1 import data_transforms

###999 with open('ImageClassifier/cat_to_name.json', 'r') as f:
...
print("your initial model was sucessfully created...")
#print(model)
