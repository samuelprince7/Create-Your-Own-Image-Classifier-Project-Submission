...
parser.add_argument('--save_model_to', default= 'ImageClassifier/saved_models' , help="Creates the path to save the origin model checkpoint, in torch.save( ) standard format") #default= 'ImageClassifier/saved_model'
...
parser.add_argument('--gpu', default=True, action='store_true', help="want to use the GPU? Default is set to True. Must set to True")
...
print("...ImageClassifier/saved_models....")
